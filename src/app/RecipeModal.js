...
//     console.log('Saving recipe for user:', userId); // Debugging line

//     await addDoc(collection(firestore, `users/${userId}/recipes`), {
//       title: recipe.title,
...
// //     try {
// //       console.log('Saving recipe:', recipe); // Debugging line
// //       await addDoc(collection(firestore, `users/${userId}/recipes`), {
// //         title: recipe.title,
// //         prepTime: recipe.prepTime,
// //         ingredients: recipe.ingredients,
